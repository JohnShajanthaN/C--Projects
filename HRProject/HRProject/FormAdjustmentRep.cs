...
namespace HRProject
{
    public partial class FrmAdjustmentRep : Form
    {
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("Adjustment Report ");
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ERROR CODE :txt-SER-104-ADJ-REP" + "\n" + "\n" + "[Please Note this Error Code and Take a Photo in this More Details." + "\n" + "\n" + "Inform the Error Code and Send this Error Details (Mail or WhatsUP) to Development Team (SRIS)!]" + "\n" + "\n" + "\n" + "MORE DETAILS :- " + "\n" + "\n" + x, "MESSAGE BOX", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void FormAdjustmentRep_Load(object sender, EventArgs e)
        {
            TxtSer_TextChanged(null, null);
        }
        ...
        private void TxtSer_TextChanged_2(object sender, EventArgs e)
        {
            TxtSer_TextChanged(null, null);
        }
        ...
        {
            EPDFReport(dataGridView1, "Adjustment Report-" + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            // set file filter of dialog   
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("Adjustment Report-" + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
