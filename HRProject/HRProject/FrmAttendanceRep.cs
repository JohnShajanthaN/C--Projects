...
namespace HRProject
{
    public partial class FrmAttendanceRep : Form
    {
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("Attendance Report ");
        ...
        public FrmAttendanceRep()
        {
            InitializeComponent();
        }

        private void FrmAttendanceRep_Load(object sender, EventArgs e)
        {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //cmd.CommandText = "select * from Attendance where AccNo Like '%" + TxtSer.Text + "%' or Branch Like '%" + TxtSer.Text + "%' or BankName Like '%" + TxtSer.Text + "%'"; cmd.ExecuteNonQuery();
