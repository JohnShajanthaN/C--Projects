...
namespace HRProject
{
    public partial class FrmDeducionCreationRepcs : Form
    {
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("Deducion Creation Report ");
        ...
        public FrmDeducionCreationRepcs()
        {
            InitializeComponent();
        }

        private void FrmDeducionCreationRepcs_Load(object sender, EventArgs e)
        {
        ...
        {
            EPDFReport(dataGridView1, "Deducion Creation Report-" + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            // set file filter of dialog   
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("Deducion Creation Report-" + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
