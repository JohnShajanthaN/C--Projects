...
namespace HRProject
{
    public partial class FrmLeaveRep : Form
    {
        ...
        private void FrmLeaveRep_Load(object sender, EventArgs e)
        {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from LEAVEREQ where EMPID Like '%" + TxtSer.Text + "%' or EmpName Like '%" + TxtSer.Text + "%' or DEPT Like '%" + TxtSer.Text + "%'";
                cmd.ExecuteNonQuery();
            ...
            {
                MessageBox.Show("ERROR CODE :txt-SER-105-LEA-REP" + "\n" + "\n" + "[Please Note this Error Code and Take a Photo in this More Details." + "\n" + "\n" + "Inform the Error Code and Send this Error Details (Mail or WhatsUP) to Development Team (SRIS)!]" + "\n" + "\n" + "\n" + "MORE DETAILS :- " + "\n" + "\n" + x, "MESSAGE BOX", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        {
            EPDFReport(dataGridView1, "Leave Report-" + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            // set file filter of dialog   
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("Leave Report-" + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
