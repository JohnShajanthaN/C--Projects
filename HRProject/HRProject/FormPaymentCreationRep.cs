...
namespace HRProject
{
    public partial class FrmPaymentCreationRep : Form
    {
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("PaymentCreation Report ");
        ...
        public FrmPaymentCreationRep()
        {
            InitializeComponent();
        }

        private void FormPaymentCreationRep_Load(object sender, EventArgs e)
        {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from PCreation where PCode Like '%" + TxtSer.Text + "%' or PName Like '%" + TxtSer.Text + "%'";
                cmd.ExecuteNonQuery();
        ...
        {
            EPDFReport(dataGridView1, "PaymentCreation Report-" + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            // set file filter of dialog   
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("PaymentCreation Report-" + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
