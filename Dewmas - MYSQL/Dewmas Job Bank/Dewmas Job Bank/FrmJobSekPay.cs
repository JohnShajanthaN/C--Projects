...
namespace Dewmas_Job_Bank
{
    public partial class FrmJobSekPay : Form
    {
        ...
        private void cmdAdd_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("Insert into JobSkPay values('"
        ...
        private void cmdEdit_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("Update JobSkPay SET JskID='" + comRegID.Text + "', Payment='" + txtPay.Text + "', PayDate='" + dtpPayDate.Text + "' WHERE StuID='" + dataGridView1.SelectedRows[0].Cells[0].Value + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
