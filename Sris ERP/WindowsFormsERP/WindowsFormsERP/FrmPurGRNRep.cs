...
{
    public partial class FrmPurGRNRep : Form
    {
        ...
        private void DGViewSize()
        {
            ...
            dataGridView1.Columns[4].HeaderText = "S.Code";
            dataGridView1.Columns[6].HeaderText = "St.No";
            dataGridView1.Columns[12].HeaderText = "Location";
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            float[] widths = new float[] { 0f, 0f, 80f, 85f, 0f, 200f, 70f, 260f, 60f, 60f, 55f, 65f, 190f };
            ...
            foreach (DataGridViewRow row in dgw.Rows)//Add Data Row  
            {
                foreach (DataGridViewCell cell in row.Cells)
                {
                    ...
                    else if (cell.ColumnIndex.ToString() == "10" || cell.ColumnIndex.ToString() == "11")
                    {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph(" Purchase GRN Sumarry ");
        ...
        private void FrmPurGRNRep_Load(object sender, EventArgs e)
        {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from PurchaseGRN where PONO Like '%" + TxtSer.Text + "%' or Supplier Like '%" + TxtSer.Text + "%' or Description Like '%" + TxtSer.Text + "%' or StockNumber Like '%" + TxtSer.Text + "%' or GRNNo Like '%" + TxtSer.Text + "%'";
                cmd.ExecuteNonQuery();
        ...
        {
            EPDFReport(dataGridView1, " Purchase GRN Sumarry - " + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = (" Purchase GRN Sumarry - " + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
