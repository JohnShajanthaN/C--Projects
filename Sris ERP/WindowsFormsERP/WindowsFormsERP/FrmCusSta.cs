...
{
    public partial class FrmCusSta : Form
    {
        int dgvRows = 0;
        string cus1 = "";
        double pp1, py1;
        ...
        private void DGViewSize()
        {
            ...
            dataGridView1.Columns[2].HeaderText = " InvRef";
            ...
            con.Open();
            OleDbCommand cmd1 = new OleDbCommand("select * from JOPayment where CustomerName='" + cus1 + "' AND (JobOrderNo Like '%" + TxtSer.Text + "%' OR RefNo Like '%" + TxtSer.Text + "%' OR InvoiceNumber Like '%" + TxtSer.Text + "%' OR InvoiceCategory Like '%" + TxtSer.Text + "%') ", con);
            cmd1.Connection = con;
            ...
            dataGridView1.Rows[dgvRows].Cells[8].Value = Convert.ToDouble(py1.ToString());
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph(cus1);
        ...
        private void FrmCusSta_Load(object sender, EventArgs e)
        {
            cus1 = FrmCusStatement.cus;
        ...
        {
            EPDFReport(dataGridView1, cus1 + " - " + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = (cus1 + " - " + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
        ...
        private void FrmCusSta_FormClosing(object sender, FormClosingEventArgs e)
        {
            FrmCusStatement FCusStatement = new FrmCusStatement();
            FCusStatement.Visible = true;
        }
