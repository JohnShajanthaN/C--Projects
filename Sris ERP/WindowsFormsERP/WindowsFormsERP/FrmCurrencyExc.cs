...
{
    public partial class FrmCurrencyExcRep : Form
    {
        ...
        private void DGViewSize()
        {
            ...
            dataGridView1.Columns[1].HeaderText = " C.Code";
            dataGridView1.Columns[2].HeaderText = " Currency";
            dataGridView1.Columns[3].HeaderText = " Rate Date";
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            float[] widths = new float[] { 100f, 100f, 300f, 190f, 100f };
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("Currency Exchange Report ");
        ...
        public FrmCurrencyExcRep()
        {
            InitializeComponent();
        }

        private void FrmCurrencyExcRep_Load(object sender, EventArgs e)
        {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ERROR CODE : SER-CNG-106-CCY-EXC-REP" + "\n" + "\n" + "[Please Note this Error Code and Take a Photo in this More Details." + "\n" + "\n" + "Inform the Error Code and Send this Error Details (Mail or WhatsUP) to Development Team (SRIS)!]" + "\n" + "\n" + "\n" + "MORE DETAILS :- " + "\n" + "\n" + x, "MESSAGE BOX", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void CmdPDF_Click(object sender, EventArgs e)
        {
            EPDFReport(dataGridView1, "Currency Exchange Report-" + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("Currency Exchange Report-" + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
