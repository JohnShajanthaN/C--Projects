...
{
    public partial class FrmChqPaymentPaid : Form
    {
        int dgvRows = 0;
        double aa = 0.00;
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            float[] widths = new float[] { 0f, 100f, 85f, 0f, 180f, 85f, 130f, 140f, 170f, 120f, 120f };
            ...
            foreach (DataGridViewRow row in dgw.Rows)//Add Data Row  
            {
                foreach (DataGridViewCell cell in row.Cells)
                {
                    ...
                    else if (cell.ColumnIndex.ToString() == "10")
                    {
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("Cheque Payment Paid Report");
        ...
        public FrmChqPaymentPaid()
        {
            InitializeComponent();
        }

        private void FrmChqPaymentPaid_Load(object sender, EventArgs e)
        {
        ...
        {
            EPDFReport(dataGridView1, "Cheque Payment Paid Report - " + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("Cheque Payment Paid Report - " + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //cmd.CommandText = "select * from VoucherChequePayment ";
                cmd.CommandText = "select * from VoucherChequePayment where PVNo Like '%" + TxtSer.Text + "%' or ChqNo Like '%" + TxtSer.Text + "%' or AccNo Like '%" + TxtSer.Text + "%' or Sup Like '%" + TxtSer.Text + "%'";
