...
{
    public partial class FrmJOCusRep : Form
    {
        int dgvRows = 0;
        string Lst1 = "";
        double pp1, qq1;
        ...
        private void DGViewSize()
        {
            ...
            dataGridView1.Columns[1].HeaderText = " Job Order No";
            ...
            con.Open();
            OleDbCommand cmd1 = new OleDbCommand("select * from JobOrder where CustomerName='" + Lst1 + "' ", con);
            cmd1.Connection = con;
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            float[] widths = new float[] { 120f, 240f };
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    Paragraph para0 = new Paragraph("Job Order - " + DateTime.Now.ToString("dd.MM.yyyy"));
        ...
        private void FrmJOCusRep_FormClosing(object sender, FormClosingEventArgs e)
        {
            FrmJOCusList FJOCusList = new FrmJOCusList();
            FJOCusList.Visible = true;
        }
        ...
        private void FrmJOCusRep_Load(object sender, EventArgs e)
        {
            Lst1 = FrmJOCusList.Lst;
            this.label1.Text = "Job Order -  " + this.Text;
            Refresh();
            this.Refresh();
            Refresh();
            this.Refresh();
