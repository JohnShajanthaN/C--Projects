...
{
    public partial class FrmUserLoginRep : Form
    {
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            float[] widths = new float[] { 125f, 125f, 125f, 125f, 125f, 125f };
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialoge.FileName, FileMode.Create))
                {
                    ...
                    pdfdoc.Open();
                    Paragraph para = new Paragraph("User Login Report ");
        ...
        public FrmUserLoginRep()
        {
            InitializeComponent();
        }

        private void FrmUserLoginRep_Load(object sender, EventArgs e)
        {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from UserLoginDetails where SystemName Like '%" + TxtSer.Text + "%' or UserID Like '%" + TxtSer.Text + "%' or UserName Like '%" + TxtSer.Text + "%'";
                cmd.ExecuteNonQuery();
            ...
            {
                MessageBox.Show("ERROR CODE : SER-CNG-107-ULOG-REP" + "\n" + "\n" + "[Please Note this Error Code and Take a Photo in this More Details." + "\n" + "\n" + "Inform the Error Code and Send this Error Details (Mail or WhatsUP) to Development Team (SRIS)!]" + "\n" + "\n" + "\n" + "MORE DETAILS :- " + "\n" + "\n" + x, "MESSAGE BOX", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void CmdPDF_Click(object sender, EventArgs e)
        {
            EPDFReport(dataGridView1, "User Login Report-" + DateTime.Now.ToString("dd.MM.yyyy"));
            OpenFileDialog dlg = new OpenFileDialog();
            dlg.Filter = "pdf files (*.pdf) |*.pdf;";
            dlg.FileName = ("User Login Report-" + DateTime.Now.ToString("dd.MM.yyyy") + ".pdf");
            dlg.ShowDialog();
