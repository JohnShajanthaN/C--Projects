...
{
    public partial class FrmChkPayDateRep : Form
    {
        int dgvRows = 0;
        string Lst1 = "";
        double pp1, qq1;
        ...
        private void DGViewSize()
        {
            ...
            con.Open();
            OleDbCommand cmd1 = new OleDbCommand("select * from VoucherChequePayment where CDate='" + Lst1 + "' ", con);
            cmd1.Connection = con;
        ...
        public FrmChkPayDateRep()
        {
            InitializeComponent();
        }

        private void FrmChkPayDateRep_Load(object sender, EventArgs e)
        {
            Lst1 = FrmChqPayDateList.Lst;
        ...
        private void FrmChkPayDateRep_FormClosing(object sender, FormClosingEventArgs e)
        {
            FrmChqPayDateList FChqPayDateList = new FrmChqPayDateList();
            FChqPayDateList.Visible = true;
        }
