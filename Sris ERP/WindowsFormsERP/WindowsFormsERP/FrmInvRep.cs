...
{
    public partial class FrmInvRep : Form
    {
        int count = 0;
        ...
        private void DGViewSize()
        {
            ...
            {
                lbls.Visible = false;
                dataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;  //"DisplayedCellsExceptHeader";
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            {
                float[] widths = new float[] { 0f, 75f, 80f, 0f, 80f, 0f, 0f, 0f, 240f, 0f, 0f, 50f, 75f, 85f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 120f, 0f, 0f, 0f, 0f, 0f, 0f };
                pdftable.SetWidths(widths);
            }                
        ...
        private void FrmInvRep_Load(object sender, EventArgs e)
        {
            count = 0;
            this.label1.Text = this.Text;
            if (this.Text == "Inventory Quantity Sumarry")
            {
                this.label4.Text = "Item";
            }
            else if (this.Text == "Invoice Report (Total by Item)")
            {
                this.label4.Text = "Item";
                this.dataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            }
            else if (this.Text == "Invoice Report (Total by Customer)")
            {
        ...
        private void TxtSer_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.label4.Text == "Item")
                {
                    cmd.CommandText = "select Description, sum(BillQuantity) as Qty, sum(ItemTotal) as Total_Amount from InvoiceCompletedDetails where Description Like '%" + TxtSer.Text + "%' GROUP BY Description";
                }
                else if (this.label4.Text == "Customer Name")
                {
            ...
            {
                MessageBox.Show("ERROR CODE : SER-CNG-104-INV-REP" + "\n" + "\n" + "[Please Note this Error Code and Take a Photo in this More Details." + "\n" + "\n" + "Inform the Error Code and Send this Error Details (Mail or WhatsUP) to Development Team (SRIS)!]" + "\n" + "\n" + "\n" + "MORE DETAILS :- " + "\n" + "\n" + x, "MESSAGE BOX", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
