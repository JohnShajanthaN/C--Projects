...
{
    public partial class FrmChkPayBankRep : Form
    {
        int dgvRows = 0;
        string Lst1 = "";
        double pp1;
        ...
        private void DGViewSize()
        {
          ...
          //  dataGridView1.Columns[8].HeaderText = " Payable";
            ...
            while (rdr.Read())
            {
                ...
                dataGridView1.Rows[dgvRows - 1].Cells[3].Value = rdr["Sup"].ToString();
                dataGridView1.Rows[dgvRows - 1].Cells[4].Value = Convert.ToDateTime(rdr["CDate"].ToString()).ToString("dd/MM/yyyy");
                dataGridView1.Rows[dgvRows - 1].Cells[5].Value = rdr["ChqNo"].ToString();
            ...
            dataGridView1.Rows[dgvRows].Cells[3].Value = "Total";
        ...
        public void EPDFReport(DataGridView dgw, string filename)
        {
            ...
            float[] widths = new float[] { 43f, 110f, 84f, 190f, 84f, 160f, 150f, 116f };
            ...
            foreach (DataGridViewRow row in dgw.Rows)//Add Data Row  
            {
                foreach (DataGridViewCell cell in row.Cells)
                {
                    ...
                    if (cell.ColumnIndex.ToString() == "2" || cell.ColumnIndex.ToString() == "4")
                    {
        ...
        public FrmChkPayBankRep()
        {
            InitializeComponent();
        }

        private void FrmChkPayBankRep_Load(object sender, EventArgs e)
        {
            Lst1 = FrmChqPayBankList.Lst;
        ...
        private void FrmChkPayBankRep_FormClosing(object sender, FormClosingEventArgs e)
        {
            FrmChqPayBankList FChqPayBankList = new FrmChqPayBankList();
            FChqPayBankList.Visible = true;
        }
