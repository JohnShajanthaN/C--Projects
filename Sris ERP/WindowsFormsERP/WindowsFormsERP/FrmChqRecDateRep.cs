...
{
    public partial class FrmChqRecDateRep : Form
    {
        int dgvRows = 0;
        string Lst1 = "";
        double pp1, qq1;
        ...
        private void DGViewSize()
        {
            ...
            con.Open();
            OleDbCommand cmd1 = new OleDbCommand("select * from JOChequePayment where CDate='" + Lst1 + "' ", con);
            cmd1.Connection = con;
            ...
            while (rdr.Read())
            {
                ...
                dataGridView1.Rows[dgvRows - 1].Cells[3].Value = rdr["Cus"].ToString();
        ...
        public FrmChqRecDateRep()
        {
            InitializeComponent();
        }

        private void FrmChqRecDateRep_Load(object sender, EventArgs e)
        {
            Lst1 = FrmChqRecDateList.Lst;
        ...
        private void FrmChqRecDateRep_FormClosing(object sender, FormClosingEventArgs e)
        {
            FrmChqRecDateList FChqRecDateList = new FrmChqRecDateList();
            FChqRecDateList.Visible = true;
        }
